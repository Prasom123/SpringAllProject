...
<nav class="navbar navbar-expand-md navbar-light "
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item"><a
					class="nav-item nav-link  text-white active" href="ShowBook">Books
				</a></li>
	...
	<div class="container mt-5">
		...
		<div class="row mx-0">
		<a class="text-primary col-md-12 my-2" href="AddToCart">View Cart</a>
				...
				<div class="col-md-3">
					<div class="card m-2" >
						...
						<div class="card-body">
							...
							<div>
							<a class="btn btn-primary" href="/Scartapp/AddToCart?bookId=${book.id}">Add to Cart</a>
							</div>
						</div>
					</div>
				</div>
